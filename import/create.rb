...
File.open("_posts/2017-03-11-resume.md","w") do |f|
	
	file = File.read('_data/aff/ligue2/stats/scorers.json')
	jsondata = JSON.parse(file)
	f.write('---')
	f.write "\n"
	f.write "layout: post"
	f.write "\n"
	f.write "title: AFF - Les stats de la semaine"
	f.write "\n"
	...
	f.write "<h2>AFF - Les stats de la semaine</h2>"
	f.write "<p>Les meilleurs buteurs de 2ème ligue</p>"
...
File.open("posts-images/image.html","w") do |f|
	...
	f.write "\n"
	# puts jsondata['top5scorers']
	f.write '<div class="stats-social-container aff" id="resume">'
